...
const char *polska_tablica[ 5 ][ 18 ] =
{
    ...
    {
	/* DOS, CP 852 */
	"\244", "\245", "\217", "\206", "\250", "\251",
	"\235", "\210", "\343", "\344", "\340", "\242",
	"\227", "\230", "\215", "\253", "\275", "\276"
    },
    {
	/* Linux, ISO 8859-2 */
	"\241", "\261", "\306", "\346", "\312", "\352",
	"\243", "\263", "\321", "\361", "\323", "\363",
	"\246", "\266", "\254", "\274", "\257", "\277"
    },
    {
	/* Windows, CP 1250 */
	"\245", "\271", "\306", "\346", "\312", "\352",
	"\243", "\263", "\321", "\361", "\323", "\363",
	"\214", "\234", "\217", "\237", "\257", "\277"
    },
    {
	/* za xterm -u8 */
	"\304\204", "\304\205", "\304\206", "\304\207", "\304\230", "\304\231",
	"\305\201", "\305\202", "\305\203", "\305\204", "\303\223", "\303\263",
	"\305\232", "\305\233", "\305\271", "\305\272", "\305\273", "\305\274"
    }
};
